...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">BRS</a>
    ...
    <section id="home">
        <div id="route-search-form">
            ...
            <p class="text-center">Welcome Bus Reservation System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                National Travels is a well-known bus agency in India, primarily operating in the southern part of the country.One of its branch is situated at Badnera, Amravati Maharashtra
                Typically, National Travels provides both sleeper and semi-sleeper buses with various amenities like air conditioning, comfortable seating, and sometimes even entertainment options onboard.
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
            <h3>National Travels</h3>
        <p>Office : Near Police  Station, Govt. Hospital, New Town, Badnera, Dist. Amravati</p>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> Made with &#10084;&#65039; by Mrunali Wahane
                        </p>
        </footer>
    </div>
